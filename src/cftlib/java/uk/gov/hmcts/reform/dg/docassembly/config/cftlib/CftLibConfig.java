package uk.gov.hmcts.reform.dg.docassembly.config.cftlib;
...
public class CftLibConfig implements CFTLibConfigurer {
    ...
    public void configure(CFTLib lib) throws Exception {
        for (String p : List.of(
                ...
                "docassemblyTestUser@docassemblyTest.com")) {
        ...
        lib.importDefinition(Files.readAllBytes(
                Path.of("src/aat/resources/adv_docassembly_functional_tests_ccd_def.xlsx")));
